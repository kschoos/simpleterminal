...
HD_PWD='C:/Users/skysk/Documents/Vivado_Projects/vga_port/vga_port.runs/BRAM_blk_mem_gen_0_3_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log BRAM_blk_mem_gen_0_3.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source BRAM_blk_mem_gen_0_3.tcl
