...
#
# Generated by Vivado on Tue Sep 24 19:35:26 +0200 2019
...
map_setup_file()
{
  ...
  if [[ ($1 != "") ]]; then
    ...
    lib_map_path="C:/Users/skysk/Documents/Vivado_Projects/vga_port/vga_port.cache/compile_simlib/activehdl"
  fi
